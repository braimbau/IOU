...
class HistoryGroupElement extends StatefulWidget {
  ...
  HistoryGroupElement({this.transaction, this.usr, this.group, this.userList});

  @override
  _HistoryGroupElementState createState() => _HistoryGroupElementState();
}

class _HistoryGroupElementState extends State<HistoryGroupElement> {
  ...
  Widget build(BuildContext context) {
    ...
    String displayedAmount = ((this.widget.transaction.getDisplayedAmount() / 100).toString());
              ...
              Row(children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      ...
                      color: (transaction.getDisplayedAmount() >= 0)
                          ? Colors.green
                          : Colors.red),
                ),
              ]),
